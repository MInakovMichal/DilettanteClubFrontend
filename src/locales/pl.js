export default {
  ...
  header: {
    ...
    room: 'Pokój',
    addQuestionsToRoom: 'Dodaj zapytania do pokoju',
    addPunishmentsToRoom: 'Dodaj kary do pokoju',
  },
