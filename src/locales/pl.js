export default {
  custom_text: {
    ...
    yes: 'Tak',
    no: 'Nie',
    players_in_room: 'Gracze w pokoju',
    no_one_player_in_room: 'Nie ma żadnego gracza w pokoju',
    your_punishments: 'Twoje kary dodane do pokoju',
  ...
  button: {
    ...
    add: 'Dodaj',
    add_punishments: 'Dodaj kary do pokoju',
    add_questions: 'Dodaj zapytania do pokoju',
  },
  error: {
    username: {
