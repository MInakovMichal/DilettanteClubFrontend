export default {
  ...
  header: {
    ...
    room: 'Room',
    addQuestionsToRoom: 'Add questions to room',
    addPunishmentsToRoom: 'Add punishments to room',
  },
